...
#### Cons:
- 15 bar pump can be hard to manage with unforgiving roasts (can be tuned to 9 bar with minimal effort, or using the [Pre-Infusion Mode only](/manufacturers/breville/preinfusion.md) trick)
