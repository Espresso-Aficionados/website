...
* From _strivefortone_: The recommendation of 2:1 H:A ratio. 2:1 ratio comes from SCA specs and was explored a lot by Chris and Maxwell in ‘Water for Coffee’. Truth be told, you can go a lot higher in hardness (3:1, even 4:1 for some coffees) but this is mainly relevant for filter coffee where it is primarily consumed at lower concentrations. You may find that exploring the inverse of this with notably higher alkalinity works quite well in the context of espresso, especially with coffees with more acidic potential where the extra buffering capability can bring a pleasant balance. See the Direct Dosing table above. Fam’s 29th Wave is an example of high buffer water designed for light roast espresso. 15-20:60-70 are also common espresso water ratios.
