...
Soup is a coffee brewing method that uses an espresso portafilter or similar filter screen but where the coffee is ground coarser than for espresso such that no or very little pressure builds up during the shot (generally less than 1 bar) yet the flow rate is high.
